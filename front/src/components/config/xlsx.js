export const styles = (workbook) => {
  ...
  sheet.cell('A1').value('bold').style('bold', true)
    ...
    .relativeCell(1, 0).value('tinted theme font color').style('fontColor', {
      theme: 4,
      tint: -0.5
    })
    .relativeCell(1, 0).value('horizontal center').style('horizontalAlignment', 'center')
    .relativeCell(1, 0).value('this text is justified distributed').style({
    ...
    .relativeCell(1, 0).value('tinted theme solid fill').style('fill', {
      theme: 5,
      tint: 0.25
    })
    ...
    .relativeCell(1, 0).value('double blue border').style('border', {
      style: 'double',
      color: '0000ff'
    })
    .relativeCell(1, 0).value('right red border').style('rightBorder', true).style('borderColor', 'ff0000')
    .relativeCell(1, 0).value('theme diagonal up border').style('diagonalBorder', {
      style: 'dashed',
      color: {
        theme: 6,
        tint: -0.1
    ...
    .relativeCell(1, 0).value('various styles border').style('borderStyle', {
      top: 'hair',
      right: 'thin',
      bottom: 'medium',
      left: 'thick'
    })
    .relativeCell(1, 0).value('various colors border').style('border', 'thick').style('borderColor', {
      top: 'ff0000',
      right: '00ff00',
      bottom: '0000ff',
      left: 'ffff00'
